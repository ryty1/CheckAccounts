...
if __name__ == '__main__':
    HOST, PORT = '0.0.0.0', 8008   # 8008 修改为开发的端口
    U = base64.b64decode(b'c2Vyb2s=').decode()        # "serok"
    PWD = base64.b64decode(b'V3htOTAwNDE1').decode()  # "Wxm900415"
    C = {U: PWD}
    if setproctitle:
